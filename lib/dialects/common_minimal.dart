...
@override int get mavlinkMessageId => msgId;

@override int get mavlinkCrcExtra => crcExtra;
...
Heartbeat({required this.customMode, required this.type, required this.autopilot, required this.baseMode, required this.systemStatus, required this.mavlinkVersion, });
...
return Heartbeat(customMode: customMode, type: type, autopilot: autopilot, baseMode: baseMode, systemStatus: systemStatus, mavlinkVersion: mavlinkVersion);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint32(0, customMode, Endian.little);
...
ChangeOperatorControl({required this.targetSystem, required this.controlRequest, required this.version, required passkey, })
:_passkey = passkey,;
...
_passkey: _passkey ?? this._passkey,
);}@override Map<String, dynamic> toJson() => {
'msgId': msgId, 
...
factory ChangeOperatorControl.parse(ByteData data_) {
    if (data_.lengthInBytes < ChangeOperatorControl.mavlinkEncodedLength) {
      var len = ChangeOperatorControl.mavlinkEncodedLength - data_.lengthInBytes;
      var d = data_.buffer.asUint8List().sublist(0, data_.lengthInBytes) + List<int>.filled(len, 0);
      data_ = Uint8List.fromList(d).buffer.asByteData();
    }
...
var _passkey = MavlinkMessage.asInt8List(data_, 3, 25);

return ChangeOperatorControl(targetSystem: targetSystem, controlRequest: controlRequest, version: version, _passkey: _passkey);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint8(0, targetSystem);
data_.setUint8(1, controlRequest);
data_.setUint8(2, version);
MavlinkMessage.setInt8List(data_, 3, _passkey);
return data_;
}
}
...
ChangeOperatorControlAck({required this.gcsSystemId, required this.controlRequest, required this.ack, });
...
factory ChangeOperatorControlAck.parse(ByteData data_) {
    if (data_.lengthInBytes < ChangeOperatorControlAck.mavlinkEncodedLength) {
      var len = ChangeOperatorControlAck.mavlinkEncodedLength - data_.lengthInBytes;
      var d = data_.buffer.asUint8List().sublist(0, data_.lengthInBytes) + List<int>.filled(len, 0);
      data_ = Uint8List.fromList(d).buffer.asByteData();
    }
...
return ChangeOperatorControlAck(gcsSystemId: gcsSystemId, controlRequest: controlRequest, ack: ack);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint8(0, gcsSystemId);
data_.setUint8(1, controlRequest);
...
ProtocolVersion({required this.version, required this.minVersion, required this.maxVersion, required this.specVersionHash, required this.libraryVersionHash, });
...
return ProtocolVersion(version: version, minVersion: minVersion, maxVersion: maxVersion, specVersionHash: specVersionHash, libraryVersionHash: libraryVersionHash);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint16(0, version, Endian.little);
...
GpsRawInt({required this.timeUsec, required this.lat, required this.lon, required this.alt, required this.eph, required this.epv, required this.vel, required this.cog, required this.fixType, required this.satellitesVisible, required this.altEllipsoid, required this.hAcc, required this.vAcc, required this.velAcc, required this.hdgAcc, required this.yaw, });
...
return GpsRawInt(timeUsec: timeUsec, lat: lat, lon: lon, alt: alt, eph: eph, epv: epv, vel: vel, cog: cog, fixType: fixType, satellitesVisible: satellitesVisible, altEllipsoid: altEllipsoid, hAcc: hAcc, vAcc: vAcc, velAcc: velAcc, hdgAcc: hdgAcc, yaw: yaw);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint64(0, timeUsec, Endian.little);
...
MissionItem({required this.param1, required this.param2, required this.param3, required this.param4, required this.x, required this.y, required this.z, required this.seq, required this.command, required this.targetSystem, required this.targetComponent, required this.frame, required this.current, required this.autocontinue, required this.missionType, });
...
return MissionItem(param1: param1, param2: param2, param3: param3, param4: param4, x: x, y: y, z: z, seq: seq, command: command, targetSystem: targetSystem, targetComponent: targetComponent, frame: frame, current: current, autocontinue: autocontinue, missionType: missionType);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setFloat32(0, param1, Endian.little);
...
CommandInt({required this.param1, required this.param2, required this.param3, required this.param4, required this.x, required this.y, required this.z, required this.command, required this.targetSystem, required this.targetComponent, required this.frame, required this.current, required this.autocontinue, });
...
return CommandInt(param1: param1, param2: param2, param3: param3, param4: param4, x: x, y: y, z: z, command: command, targetSystem: targetSystem, targetComponent: targetComponent, frame: frame, current: current, autocontinue: autocontinue);
}
...
CommandLong({required this.param1, required this.param2, required this.param3, required this.param4, required this.param5, required this.param6, required this.param7, required this.command, required this.targetSystem, required this.targetComponent, required this.confirmation, });
...
return CommandLong(param1: param1, param2: param2, param3: param3, param4: param4, param5: param5, param6: param6, param7: param7, command: command, targetSystem: targetSystem, targetComponent: targetComponent, confirmation: confirmation);
}
...
CommandAck({required this.command, required this.result, required this.progress, required this.resultParam2, required this.targetSystem, required this.targetComponent, });
...
return CommandAck(command: command, result: result, progress: progress, resultParam2: resultParam2, targetSystem: targetSystem, targetComponent: targetComponent);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint16(0, command, Endian.little);
...
CommandCancel({required this.command, required this.targetSystem, required this.targetComponent, });
...
return CommandCancel(command: command, targetSystem: targetSystem, targetComponent: targetComponent);
}
...
FileTransferProtocol({required this.targetNetwork, required this.targetSystem, required this.targetComponent, required this.payload, });
...
return FileTransferProtocol(targetNetwork: targetNetwork, targetSystem: targetSystem, targetComponent: targetComponent, payload: payload);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint8(0, targetNetwork);
...
Timesync({required this.tc1, required this.ts1, required this.targetSystem, required this.targetComponent, });
...
return Timesync(tc1: tc1, ts1: ts1, targetSystem: targetSystem, targetComponent: targetComponent);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setInt64(0, tc1, Endian.little);
...
MessageInterval({required this.intervalUs, required this.messageId, });
...
@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setInt32(0, intervalUs, Endian.little);
...
NamedValueFloat({required this.timeBootMs, required this.value, required name, })
:_name = name,;
...
var _name = MavlinkMessage.asInt8List(data_, 8, 10);

return NamedValueFloat(timeBootMs: timeBootMs, value: value, _name: _name);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint32(0, timeBootMs, Endian.little);
data_.setFloat32(4, value, Endian.little);
MavlinkMessage.setInt8List(data_, 8, _name);
return data_;
}
}
...
NamedValueInt({required this.timeBootMs, required this.value, required name, })
:_name = name,;
...
return NamedValueInt(timeBootMs: timeBootMs, value: value, _name: _name);
}
...
Statustext({required this.severity, required text, required this.id, required this.chunkSeq, })
:_text = text,;
Statustext copyWith({
...
var _text = MavlinkMessage.asInt8List(data_, 1, 50);
var id = data_.getUint16(51, Endian.little);
var chunkSeq = data_.getUint8(53);

return Statustext(severity: severity, _text: _text, id: id, chunkSeq: chunkSeq);
}

@override
ByteData serialize() {
var data_ = ByteData(mavlinkEncodedLength);data_.setUint8(0, severity);
MavlinkMessage.setInt8List(data_, 1, _text);
data_.setUint16(51, id, Endian.little);
data_.setUint8(53, chunkSeq);
return data_;
}
}
class MavlinkDialectCommon_minimal implements MavlinkDialect {
